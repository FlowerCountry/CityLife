...
func TestCreateSession(t *testing.T) {
	...
	t.Run("Session计数增加", func(t *testing.T) {
		...
		env.doRequest("POST", "/api/v2/sessions", nil)
...
func TestGetSession(t *testing.T) {
	...
	t.Run("获取存在的Session", func(t *testing.T) {
		...
		w := env.doRequest("GET", "/api/v2/sessions/"+sessionID, nil)
	...
	t.Run("获取不存在的Session", func(t *testing.T) {
		w := env.doRequest("GET", "/api/v2/sessions/non-existent-id", nil)
...
func TestDeleteSession(t *testing.T) {
	...
	t.Run("删除存在的Session", func(t *testing.T) {
		...
		w := env.doRequest("DELETE", "/api/v2/sessions/"+sessionID, nil)
	...
	t.Run("删除不存在的Session", func(t *testing.T) {
		w := env.doRequest("DELETE", "/api/v2/sessions/non-existent-id", nil)
